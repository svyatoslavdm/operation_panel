#ifndef INTERACTIVE_MARKER_UNSCREW_CHOOSER_H_
#define INTERACTIVE_MARKER_UNSCREW_CHOOSER_H_

#include "InteractiveMarkerBase.h"

class InteractiveMarkerUnscrewChooser : public InteractiveMarkerBase
{
public:    
    InteractiveMarkerUnscrewChooser();
...
#endif //INTERACTIVE_MARKER_UNSCREW_CHOOSER_H_
